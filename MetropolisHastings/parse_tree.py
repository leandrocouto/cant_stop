...
class ParseTree:
    ...
    def build_glenn_tree(self, is_yes_no):
        if is_yes_no:
            ...
            # First weights
            child_4 = Node(node_id = 4, value = r"progress_value=[", is_terminal = True, parent = child_header.value)
            ...
            child_22 = Node(node_id = 22, value = r"]\n\t\tmove_value=[", is_terminal = True, parent = child_header.value)
            # Second weights
            child_23 = Node(node_id = 23, value = r"INTEGERS", is_terminal = False, parent = child_header.value)
            child_24 = Node(node_id = 24, value = r"7", is_terminal = True, parent = child_23.value)
            ...
            child_27 = Node(node_id = 27, value = r"0", is_terminal = True, parent = child_26.value)
            ...
            child_30 = Node(node_id = 30, value = r"2", is_terminal = True, parent = child_29.value)
            ...
            child_33 = Node(node_id = 33, value = r"0", is_terminal = True, parent = child_32.value)
            ...
            child_header.children.extend((child_4, child_5, child_7, child_8, child_10, child_11, child_13, 
                ...
                child_44, child_46, child_47, child_49, child_50, child_52, child_53, child_55, child_56))
            # interlude
            child_58 = Node(node_id = 58, value = r"\n", is_terminal = True, parent = self.root.value)
            child_59 = Node(node_id = 59, value = r"\t", is_terminal = True, parent = self.root.value)
            child_60 = Node(node_id = 60, value = r"\t", is_terminal = True, parent = self.root.value)
            #body if
            child_if = Node(node_id = 61, value = r"body_if", is_terminal = False, parent = self.root.value)
            child_62 = Node(node_id = 62, value = r"if", is_terminal = True, parent = child_if.value)
            child_63 = Node(node_id = 63, value = r"actions[0]", is_terminal = True, parent = child_if.value)
            child_64 = Node(node_id = 64, value = r"in", is_terminal = True, parent = child_if.value)
            child_65 = Node(node_id = 65, value = r"['y','n']:", is_terminal = True, parent = child_if.value)
            child_66 = Node(node_id = 66, value = r"\n\t\t\tif", is_terminal = True, parent = child_if.value)
            child_67 = Node(node_id = 67, value = r"bool_template", is_terminal = False, parent = child_if.value)
            '''
                child_68 = Node(node_id = 68, value = r"(", is_terminal = True, parent = child_67.value)
                child_69 = Node(node_id = 69, value = r"bool_template", is_terminal = False, parent = child_67.value)
                    child_70 = Node(node_id = 70, value = r"bool_exp", is_terminal = False, parent = child_69.value)
                        child_71 = Node(node_id = 71, value = r"functions_bool", is_terminal = False, parent = child_70.value)
                            child_72 = Node(node_id = 72, value = r"ExperimentalDSL.will_player_win_after_n(state)", is_terminal = True, parent = child_71.value)
                    child_73 = Node(node_id = 73, value = r"BOOL_OP", is_terminal = False, parent = child_69.value)
                        child_74 = Node(node_id = 74, value = r"or not", is_terminal = True, parent = child_73.value)
                    child_75 = Node(node_id = 75, value = r"bool_exp", is_terminal = False, parent = child_69.value)
                        child_76 = Node(node_id = 76, value = r"ExperimentalDSL.are_there_available_columns_to_play(state)", is_terminal = True, parent = child_75.value)
                child_77 = Node(node_id = 77, value = r")", is_terminal = True, parent = child_67.value)
                child_78 = Node(node_id = 78, value = r"BOOL_OP", is_terminal = False, parent = child_67.value)
                    child_79 = Node(node_id = 79, value = r"and", is_terminal = True, parent = child_78.value)
                child_80 = Node(node_id = 80, value = r"(", is_terminal = True, parent = child_67.value)
                child_81 = Node(node_id = 81, value = r"bool_template", is_terminal = False, parent = child_67.value)
                    child_82 = Node(node_id = 82, value = r"bool_exp", is_terminal = False, parent = child_81.value)
                        child_83 = Node(node_id = 83, value = r"functions_bool", is_terminal = False, parent = child_82.value)
                            child_84 = Node(node_id = 84, value = r"ExperimentalDSL.will_player_win_after_n(state)", is_terminal = True, parent = child_83.value)
                    child_85 = Node(node_id = 85, value = r"BOOL_OP", is_terminal = False, parent = child_81.value)
                        child_86 = Node(node_id = 86, value = r"or", is_terminal = True, parent = child_85.value)
                    child_87 = Node(node_id = 87, value = r"bool_exp", is_terminal = False, parent = child_81.value)
                        #"functions_yes_no OP functions_yes_no COMP_OP variable"
                        child_88 = Node(node_id = 88, value = r"functions_yes_no", is_terminal = False, parent = child_87.value)
                            child_89 = Node(node_id = 89, value = r"ExperimentalDSL.calculate_score(state,", is_terminal = True, parent = child_88.value)
                            child_90 = Node(node_id = 90, value = r"vector", is_terminal = False, parent = child_88.value)
                                child_91 = Node(node_id = 91, value = r"progress_value", is_terminal = True, parent = child_90.value)
                            child_92 = Node(node_id = 92, value = r")", is_terminal = True, parent = child_88.value)
                        child_93 = Node(node_id = 93, value = r"OP", is_terminal = False, parent = child_87.value)
                            child_94 = Node(node_id = 94, value = r"+", is_terminal = True, parent = child_93.value)
                        child_95 = Node(node_id = 95, value = r"functions_yes_no", is_terminal = False, parent = child_87.value)
                            child_96 = Node(node_id = 96, value = r"ExperimentalDSL.calculate_difficulty_score(state, odds, evens, highs, lows)", is_terminal = True, parent = child_95.value)
                        child_97 = Node(node_id = 97, value = r"COMP_OP", is_terminal = False, parent = child_87.value)
                            child_98 = Node(node_id = 98, value = r">=", is_terminal = True, parent = child_97.value)
                        child_99 = Node(node_id = 99, value = r"variable", is_terminal = False, parent = child_87.value)
                            child_100 = Node(node_id = 100, value = r"threshold", is_terminal = True, parent = child_99.value)
                child_101 = Node(node_id = 101, value = r")", is_terminal = True, parent = child_67.value)
            child_102 = Node(node_id = 102, value = r":\n\t\t\t\treturn", is_terminal = True, parent = child_if.value)
            child_103 = Node(node_id = 103, value = r"'n'\n\t\t\telse:\n\t\t\t\treturn", is_terminal = True, parent = child_if.value)
            child_104 = Node(node_id = 104, value = r"'y'", is_terminal = True, parent = child_if.value)
            '''
            ...
            child_71.children.extend((child_72,))
            child_70.children.extend((child_71,))
            child_73.children.extend((child_74,))
            child_75.children.extend((child_76,))
            child_69.children.extend((child_70, child_73, child_75))
            child_78.children.extend((child_79,))
            child_83.children.extend((child_84,))
            child_82.children.extend((child_83,))
            child_85.children.extend((child_86,))
            child_90.children.extend((child_91,))
            child_88.children.extend((child_89, child_90, child_92))
            child_93.children.extend((child_94,))
            child_95.children.extend((child_96,))
            child_97.children.extend((child_98,))
            child_99.children.extend((child_100,))
            child_87.children.extend((child_88, child_93, child_95, child_97, child_99))
            child_81.children.extend((child_82, child_85, child_87))
            child_67.children.extend((child_68, child_69, child_77, child_78, child_80, child_81, child_101))
            child_if.children.extend((child_62, child_63, child_64, child_65, child_66, child_67, child_102, child_103, child_104))
            self.root.children.extend((child_1, child_2, child_header, child_58, child_59, child_60, child_if))
            ...
            child_18 = Node(node_id = 18, value = r"move_value[5-abs(column-7)]", is_terminal = True, parent = child_15.value)
