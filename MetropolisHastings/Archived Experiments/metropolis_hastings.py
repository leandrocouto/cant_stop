...
class MetropolisHastings:
    def __init__(self, beta, n_iterations, n_games_glenn, n_games_uct, 
        uct_playouts, eval_step, threshold, tree_max_nodes, string_dataset, 
    ...
    def generate_report(self):
        ...
        for i in range(len(self.uct_playouts)):
            ...
            plt.legend(loc="best")
            plt.title("Metropolis Hastings - Games against UCT - " + str(self.uct_playouts[i]) + " playouts")
            plt.xlabel('Iterations')
            plt.ylabel('Number of games')
